...
@Component({
  selector: 'app-annonceurscampagnes',
  templateUrl: './annonceurscampagnes.component.html',
  styleUrls: ['./annonceurscampagnes.component.css']
})
export class AnnonceurscampagnesComponent implements OnInit {
